/* 
Every now and then people in the office moves teams or departments. Depending what people 
are doing with their time they can become more or less boring. Time to assess the current 
team.
...
function boredom(staff) {
  ...
  for (let key in staff) {
    totalScore += boredomScore[staff[key]];
  }

  return totalScore <= 80
    ? "kill me now"
    : totalScore < 100 && totalScore > 80
    ? "i can handle this"
    : "party time!!";
}
