...
your boring real job, you've been using the work computers to smash in endless hours of 
codewars.

In a team meeting, a terrible, awful person declares to the group that you aren't 
working. You're in trouble. You quickly have to gauge the feeling in the room to decide 
...
*/
// P: Takes in an object and a string
// R: Returns a string
// E:
...
function outed(meet, boss) {
  ...
  return (sum + meet[boss]) / length <= 5 ? "Get Out Now!" : "Nice Work Champ!";
}
