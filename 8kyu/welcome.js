...
// welcome('dutch') --> 'Welkom'
// welcome('IP_ADDRESS_INVALID') --> 'not a valid ipv4 or ipv6 ip address'
//P:
...
function welcome(language) {
    //Store available languages in an object
    //Check if language exists in object
    //Return if it does.
