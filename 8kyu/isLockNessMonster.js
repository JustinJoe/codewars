...
for some 10 odd minutes. You ask, "how much do people normally tip for something like this?" 
...
a solution for finding The Loch Ness Monster. Note that the phrase can also be written as 
"3.50" or "three fifty".
*/
// P: Takes in a string
// R: Returns a boolean
...
function isLockNessMonster(string) {
  // includes "three fifty" or "3.5"
  return (
    string.includes("three fifty") ||
    string.includes("3.50") ||
    string.includes("tree fiddy")
  );
}
