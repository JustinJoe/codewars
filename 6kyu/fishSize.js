/* 
In this Kata you are fish in a pond that needs to survive by eating other fish. You can only 
eat fish that are the same size or smaller than yourself. 
You must create a function called fish that takes a shoal of fish as an input string. From 
this you must work out how many fish you can eat and ultimately the size you will grow to.
Rules
...
8.  The bigger fish you eat, the faster you grow. A size 2 fish equals two size 1 fish, size 
3 fish equals three size 1 fish, and so on.
...
// fishSize("1111") --> 2
// fishSize("11112222") --> 3
// fishSize("111122223333") --> 4
// fishSize("111111111111") --> 3
// fishSize("111111111111111111112222222222") --> 5
// fishSize("151128241212192113722321331") --> 5
function fishSize(shoal) {
  // let size = 0, fish = 0;

  // Split into digits
  // Sort digits in ascending order
  // add current fish to fish total (fish)
  // if fish >= size * 4
  // fish -= size++ * 4
...
console.log(fishSize("0"));
console.log(fishSize("6"));
console.log(fishSize("1111"));
console.log(fishSize("11112222"));
console.log(fishSize("111122223333"));
console.log(fishSize("111111111111"));
console.log(fishSize("111111111111111111112222222222"));
console.log(fishSize("151128241212192113722321331"));
