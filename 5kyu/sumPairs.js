...
NOTE: There will also be lists tested of lengths upwards of 10,000,000 elements. Be 
sure your code doesn't time out.
*/

// P: Takes in an array of integers and an integer
// R: Returns an array
// E:
...
function sumPairs(array, sum) {
  ...
  for (let i = 0; i < array.length; i++) {
    if (numbers[sum - array[i]]) return [sum - array[i], array[i]];
